        ...
        <div>
          {isTablet ? (
            ...
            <div
              ...
              style={{ backgroundColor: selectedWork.theme }}
            >
              <article
                className="flex flex-col flex-nowrap justify-between gap-1 py-8 pt-36 md:flex-row md:gap-x-5 md:max-w-5xl  md:mx-auto md:my-0"
                data-aos="fade-up"
              >
                <div className="relative md:w-1/2">
                  <img
                    src={selectedWork.image.hero}
                    alt={`${selectedWork.name} hero image`}
            ...
            {selectedWork.featureExplain ? (
              <div className="work-features pb-3" data-aos="fade-up">
                ...
                {selectedWork.featureImg ? (
                  <img
                    src={selectedWork.featureImg}
                    alt={`${selectedWork.name} feature highlight`}
                    className="block h-auto w-full object-contain rounded-lg  md:mx-auto md:my-0"
                  />
                ) : (
                  ""
                )}
                ...
                {selectedWork.codeSnippet ? (
                  <img
                    src={selectedWork.codeSnippet}
                    alt={`${selectedWork.name} feature code snippet`}
                    className="block h-auto w-full object-contain rounded-md md:w-3/4 md:mx-auto md:my-0"
                  />
                ) : (
                  ""
                )}
            ...
            {selectedWork.designExplain ? (
              <div className="work-design pb-3" data-aos="fade-up">
                ...
                {selectedWork.designImg ? (
                  <img
                    src={selectedWork.designImg}
                    alt={`${selectedWork.name} design highlight`}
                    className="block h-auto w-full object-contain rounded-lg  md:mx-auto md:my-0"
                  />
                ) : (
                  ""
