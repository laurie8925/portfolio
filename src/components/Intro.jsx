  ...
  return (
    <div className='intro-section relative '>
      ...
      <div className='flex flex-col items-center justify-center  h-screen z-50 overflow-hidden'>
        <h1 className='z-30 text-5xl font-bold sm:text-7xl xl:text-8xl'>Laurie Yeh</h1>
        <p className='text-base uppercase tracking-wide text-pretty sm:text-xl sm:tracking-wider'> Front End Web Developer <span className='mx-w-md:hidden'> | </span> UX Designer</p>
